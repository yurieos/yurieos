    ...
    <div className="min-h-svh w-full overflow-y-auto">
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-24">
        ...
        <div className="prose prose-neutral dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-h2:text-xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-base prose-h3:mt-6 prose-h3:mb-3 prose-p:text-muted-foreground prose-p:leading-relaxed prose-li:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground max-w-none">
          ...
          <h3>1.4 Categories of Personal Information (CCPA)</h3>
          <p>
          ...
          <p>Processing necessary for our legitimate interests, including:</p>
          <ul>
          ...
          <ul>
            <li>
              <strong>No model training:</strong> Your prompts and the AI&apos;s
              responses are NOT used to train or improve Google&apos;s AI models
            </li>
            <li>
          ...
          <h3>4.2 Temporary File Storage</h3>
          <p>
          ...
          <ul>
            ...
            <li>
              Content that violates Google&apos;s Generative AI Prohibited Use
              Policy
            </li>
          </ul>
          ...
          <p>
            <strong>Purpose:</strong> AI processing for chat
          </p>
          <p>
          ...
          <h3>5.2 Supabase</h3>
          <p>
            <strong>Purpose:</strong> Authentication and user management
          </p>
          <p>
            <strong>Data processed:</strong> Account data
          </p>
          <p>
          ...
          <ul>
            <li>
              <strong>Authentication cookies:</strong> Session duration,
              first-party
            </li>
            <li>
