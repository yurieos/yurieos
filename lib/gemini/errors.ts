...
export class GeminiSafetyError extends GeminiError {
  ...
  constructor(
    message: string = 'Content blocked by safety filters',
...
export class GeminiQuotaError extends GeminiError {
  constructor(
    message: string = 'API quota exceeded. Please check your usage limits.',
    options?: { cause?: Error }
  ) {
    super(message, { statusCode: 429, cause: options?.cause })
...
export class GeminiModelError extends GeminiError {
  ...
  constructor(
    message: string = 'Model is unavailable',
...
export class GeminiRecitationError extends GeminiError {
  constructor(
    message: string = 'Response blocked due to potential recitation of training data',
    options?: { cause?: Error }
  ) {
    super(message, { cause: options?.cause })
...
export class GeminiTokenLimitError extends GeminiError {
  ...
  constructor(
    message: string = 'Content exceeds token limits',
