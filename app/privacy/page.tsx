        ...
        <div className="flex flex-col items-center gap-6">
          <Card className="w-full">
            ...
            <CardContent className="prose prose-sm prose-neutral dark:prose-invert max-w-none">
              ...
              <p>
                We use this information solely for authentication purposes and
              ...
              <p>
                Your queries are processed by Google&apos;s Gemini AI models.
                Google may process this data according to their{' '}
                <a
              ...
              <h3>3.2 Supabase</h3>
              <p>
                We use Supabase for authentication and user management. Your
                account data is stored securely on Supabase&apos;s
                infrastructure. See their{' '}
                <a
              ...
              <p>
                Your chat history is stored using Upstash Redis for fast
                retrieval and persistence. See their{' '}
                <a
              ...
              <p>
                ...
                or as needed to provide you the Service. You may delete your
                chat history at any time through the application. If you delete
              ...
              <p>
                We use Vercel Analytics which may use cookies for usage
                analysis. You can disable cookies in your browser settings, but
                this may affect Service functionality.
              </p>

              <h2>8. Children&apos;s Privacy</h2>
              <p>
                The Service is not intended for users under 13 years of age. We
