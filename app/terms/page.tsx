      ...
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-24">
        ...
        <div className="prose prose-neutral dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-h2:text-xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-base prose-h3:mt-6 prose-h3:mb-3 prose-p:text-muted-foreground prose-p:leading-relaxed prose-li:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground max-w-none">
          <p className="text-base leading-relaxed">
            ...
            your access to and use of the Yurie AI-powered answer engine service
            at <a href="https://www.yurie.ai">www.yurie.ai</a> (the
          ...
          <p>
            Yurie is an AI-powered answer engine that uses Google&apos;s Gemini
            AI models to provide research assistance and answer questions. The
            Service includes:
          </p>
          <ul>
            <li>
          ...
          <p>
            ...
            Gemini API, Supabase, Upstash, and Vercel. Your use of these
            integrated services is subject to their respective terms and
          ...
          <p>
            ...
            to its conflict of law provisions. Any disputes shall be resolved in
