      ...
      <div className="mx-auto max-w-2xl px-6 py-16 md:py-24">
        ...
        <div className="prose prose-neutral dark:prose-invert prose-headings:font-semibold prose-headings:tracking-tight prose-h2:text-xl prose-h2:mt-10 prose-h2:mb-4 prose-h3:text-base prose-h3:mt-6 prose-h3:mb-3 prose-p:text-muted-foreground prose-p:leading-relaxed prose-li:text-muted-foreground prose-a:text-foreground prose-a:no-underline hover:prose-a:underline prose-strong:text-foreground max-w-none">
          ...
          <ul>
            ...
            <li>AI image generation using Gemini Image models</li>
            <li>AI video generation using Veo models</li>
          ...
          <ul>
            ...
            <li>
              Create content designed to harass, bully, or intimidate individuals
            </li>
          ...
          <ul>
            ...
            <li>
              Conduct automated scraping, crawling, or data extraction
            </li>
          ...
          <ul>
            <li>Make substantial creative contributions (editing, selection, arrangement)</li>
          ...
          <ul>
            <li>Scheduled maintenance (we will try to provide advance notice)</li>
          ...
          <ul>
            ...
            <li>
              You are not on any US government prohibited party list
            </li>
            <li>
              You will not use the Service in violation of US export laws
            </li>
          </ul>
          ...
          <p>
            <strong>
              ...
              notice to{' '}
              <a href="mailto:os@yurie.ai">os@yurie.ai</a> within 30 days of
          ...
          <p>
            <strong>
              YOU AND WE AGREE THAT ANY DISPUTE RESOLUTION PROCEEDINGS,
          ...
          <h2>25. Survival</h2>
          <p>
            The following sections survive termination of these Terms: Section
            5 (AI-Generated Content), Section 6 (Intellectual Property), Section
          ...
          <p>
            ...
            entire agreement between you and us regarding the Service. These
            Terms supersede any prior agreements, communications, or
