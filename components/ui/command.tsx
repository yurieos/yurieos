...
const CommandDialog = ({ children, ...props }: DialogProps) => {
  return (
    <Dialog {...props}>
      <DialogContent className="overflow-visible p-0 shadow-lg max-h-[85vh] flex flex-col">
...
>(({ className, ...props }, ref) => (
  <CommandPrimitive.List
    ref={ref}
    className={cn(
      'max-h-[min(400px,50vh)] overflow-y-auto overflow-x-hidden overscroll-contain scroll-smooth',
      className
    )}
    {...props}
  />
