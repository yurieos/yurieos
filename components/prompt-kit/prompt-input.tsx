...
function PromptInput({
  ...
  return (
    ...
    >
      <div
        className={cn(
          "rounded-[28px] border border-border/50 bg-transparent p-2 shadow-xs dark:bg-input/30",
          className
        )}
      >
        {children}
...
const PromptInputTextarea = React.forwardRef<HTMLTextAreaElement, PromptInputTextareaProps>(
  ...
  return (
    <Textarea
      ...
      className={cn(
        "min-h-[48px] w-full resize-none border-0 bg-transparent p-3 text-foreground shadow-none outline-none placeholder:text-muted-foreground focus:ring-0 focus-visible:ring-0 focus-visible:ring-offset-0",
        "overflow-y-auto",
        className
      )}
      style={{
...
function PromptInputActions({
  ...
  return (
    <div
      className={cn("flex items-center gap-2 p-1 pt-0", className)}
      {...props}
    >
      {children}
    </div>
